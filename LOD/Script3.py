...
p = linPosHP  # 필터링된 선형 위치 데이터
R = R  # 회전 행렬 데이터

# 애니메이션 생성
anim = SixDOFanimation(p, R, SamplePlotFreq=8, Title='Unfiltered', CreateAVI=False)

plt.show()

anim.save("6DOF_Animation.mp4", writer=FFMpegWriter(fps=30))